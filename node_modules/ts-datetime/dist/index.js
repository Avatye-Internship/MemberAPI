...
var formatDateWithString = function (date, format) {
    var map = {
        m: date.getMonth(),
    ...
    return format.replace(/mm|m|MM|dd|DD|yyyy|yyy|yy/gi, function (matched) { return map[matched]; });
};

export { formatDate, formatDateWithString, getDayString, getMonthString };
